...
public class BuildYourOwnComputerPage extends Utility {
    ...
    public String getProductNameText() {
        ...
        log.info("Getting the ProductName text :" + productNameText.toString());
        return message;
    }

    public void selectProcessor(String processorName) {
        selectByVisibleTextFromDropDown(processor, processorName);
        log.info("Getting the ProductName text :" + processor.toString());
    ...
    public void clickOnAddToCartButton() {
        ...
        log.info("Click Add to Cart Button : "+ addToCartBtn.toString());
    }

    public String getProductAddedMessage() {
        String message = getTextFromElement(productAddeMessage);
        log.info("Get Product Message: "+ productAddeMessage);
        return message;
    }
}
