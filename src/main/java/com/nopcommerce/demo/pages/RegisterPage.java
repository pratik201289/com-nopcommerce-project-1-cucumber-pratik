...
public class RegisterPage extends Utility {
    ...
    public void enterFirstName(String firstName) {
        ...
        log.info("Enter Firstname : '" + firstName.toString() + "' to firstName field" + "<br>");
    }

    public void enterLastName(String lastName) {
        sendTextToElement(lastNameField, lastName);
        log.info("Enter Lastname : '" + lastName.toString() + "' to lastName field" + "<br>");
    }
    ...
    public void clickOnRegisterButton() {
        log.info("Click on 'REGISTER' button" + "<br>" + registerBtn.toString());
    ...
    public String getValidationErrorMessageForField(String fieldName) {
        ...
        for (WebElement message : fieldValidationErrors) {
            if (message.getAttribute("data-valmsg-for").equals(fieldName)) {
                ...
                log.info("Verify Error Message" + "<br>"+ fieldValidationErrors.toString());
    ...
    public void clickOnContinueButton() {
        log.info("Click on 'CONTINUE' button" + "<br>" + continueBtn.toString());
